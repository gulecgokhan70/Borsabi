        ...
        <table className="w-full text-sm hidden lg:table">
          <thead>
            <tr className="border-b border-[#334155]">
              ...
              <th className="text-right py-3 px-3 text-[#94A3B8] font-medium">Fiyat</th>
              <th className="text-right py-3 px-3 text-[#94A3B8] font-medium">Değişim</th>
              ...
              <th className="text-left py-3 px-3 text-[#94A3B8] font-medium">Sinyaller</th>
            </tr>
          </thead>
          <tbody>
            {trades.map((t, idx) => (
              <tr key={t.symbol} className="border-b border-[#1E293B] hover:bg-[#1E293B]/50 transition-colors">
                ...
                <td className="py-3 px-3 text-right font-medium text-white">{formatCurrency(t.price)}</td>
                ...
                <td className="py-3 px-3">
                  <div className="flex flex-wrap gap-1 max-w-[200px]">
                    {t.signals.slice(0, 3).map((s, i) => (
                      <span key={i} className="text-[10px] px-1.5 py-0.5 rounded bg-[#334155] text-[#94A3B8]">{s}</span>
                    ))}
                  </div>
                </td>
              </tr>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-right">
                  <div className="text-white font-bold">{formatCurrency(t.price)}</div>
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-[#94A3B8] text-sm">Tüm BIST hisseleri analiz ediliyor...</p>
          <p className="text-[#64748B] text-xs mt-1">Bu işlem 30-60 saniye sürebilir</p>
        </div>
      )}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div key={idx} className="bg-[#1E293B] rounded-xl p-4 border border-[#334155]">
                ...
                <p className={`${stat.isText ? 'text-sm' : 'text-xl'} font-bold text-white`}>{stat.value}</p>
              </div>
            ))}
          </div>
          ...
          <div className="bg-[#1E293B] rounded-xl border border-[#334155] overflow-hidden">
            <div className="p-5 border-b border-[#334155]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-white">En İyi 5 Day Trading Hissesi</h2>
            ...
            <div className="p-5">
              {data.dayTrade.length > 0 ? (
                ...
                <p className="text-center text-[#64748B] py-8">Day trading için uygun hisse bulunamadı</p>
              )}
            </div>
          </div>
          ...
          <div className="bg-[#1E293B] rounded-xl border border-[#334155] overflow-hidden">
            <div className="p-5 border-b border-[#334155]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-white">En İyi 5 Swing Trading Hissesi</h2>
                  <p className="text-xs text-[#64748B]">
            ...
            <div className="p-5">
              {data.swingTrade.length > 0 ? (
                ...
                <p className="text-center text-[#64748B] py-8">Swing trading için uygun hisse bulunamadı</p>
              )}
            </div>
          </div>
      ...
      {!data && !loading && !error && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <h2 className="text-xl font-bold text-white mb-2">Akşam Analizi Hazır</h2>
