...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#0F172A]">
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#0F172A] border-r border-[#1E293B] transform transition-transform duration-300 lg:relative lg:translate-x-0 ${
        ...
        <div className="flex flex-col h-full">
          ...
          {/* Risk info */}
          <div className="px-4 py-3 mx-3 mb-3 rounded-lg bg-[#1E293B] border border-[#334155]">
      ...
      <main className="flex-1 overflow-y-auto">
        {/* Mobile header */}
        <div className="sticky top-0 z-30 flex items-center gap-3 px-4 py-3 bg-[#0F172A]/95 backdrop-blur-sm border-b border-[#1E293B] lg:hidden">
          <button onClick={() => setSidebarOpen(true)} className="p-2 rounded-lg text-[#94A3B8] hover:text-white hover:bg-[#1E293B]">
