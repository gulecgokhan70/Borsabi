...
const req = (body: unknown, origin = 'https://borsabi.com') => new NextRequest('https://borsabi.com/api/bot-lab/budget', { method: 'POST', headers: { 'content-type': 'application/json', origin }, body: JSON.stringify(body) });
